 ...
 * @param modifier Compose [modifier.Modifier] for layout and styling.
...
/**
 * Creates a [org.gnome.adw.AboutDialog], a standardized dialog for displaying io.github.compose4gtk.adw.application metadata and credits.
 *
 * @param title The title shown in the dialog header.
 * @param applicationName The name of the io.github.compose4gtk.adw.application.
 * @param modifier Compose [modifier.Modifier] for layout and styling.
 * @param applicationIcon The name of the io.github.compose4gtk.adw.application icon.
 * @param artists The list of artists of the io.github.compose4gtk.adw.application.
 * @param comments The comments about the io.github.compose4gtk.adw.application.
 * @param contentHeight The height of the content.
 * @param contentWidth The width of the content.
 ...
 * @param designers The list of designers of the io.github.compose4gtk.adw.application.
 * @param developerName The developer name.
 * @param developers The list of developers of the io.github.compose4gtk.adw.application.
 * @param documenters The list of documenters of the io.github.compose4gtk.adw.application.
 * @param issueUrl The URL for the io.github.compose4gtk.adw.application’s issue tracker.
 * @param followsContentSize Whether to size content automatically.
 * @param license The license text.
 * @param licenseType The license type.
 * @param presentationMode Which mode used to display the dialog.
 * @param releaseNotes The release notes of the io.github.compose4gtk.adw.application.
 * @param releaseNotesVersion The version described by the io.github.compose4gtk.adw.application’s release notes.
 * @param supportUrl The URL of the io.github.compose4gtk.adw.application’s support page.
 * @param translatorCredits The translator credits string.
 * @param version The version of the io.github.compose4gtk.adw.application.
 * @param website The URL of the io.github.compose4gtk.adw.application's website.
 * @param onClose Callback triggered when the dialog is closed.
 * @param content The composable content to display inside the dialog.
 */
@Composable
