 ...
 * @param horizontalAdjustment An [org.gnome.gtk.Adjustment] used to change the horizontal handling of the children.
 * @param verticalAdjustment An [org.gnome.gtk.Adjustment] used to change the vertical handling of the children.
