...
/**
 * The size of the GTK [org.gnome.gtk.Image].
 * The possible values correspond to GTK's [org.gnome.gtk.IconSize], plus the [Specific] class to represent
 * an exact value that will be set with [org.gnome.gtk.Image.setPixelSize].
 */
