...
/**
 * Creates a [org.gnome.gtk.ApplicationWindow], a freeform io.github.compose4gtk.gtk.application window.
 *
 ...
 * @param styles A list of [org.gnome.gtk.CssProvider] used to style the window.
